...
Durante o desenvolvimento deste projeto, foi possível praticar a criação de layouts, estilização de páginas, manipulação de elementos da interface e organização de um sistema web com múltiplas páginas.
